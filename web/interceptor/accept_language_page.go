...
type AcceptLanguagePage struct {
	trama.NopWebInterceptor
	handler languageMessager
}

func NewAcceptLanguagePage(h languageMessager) *AcceptLanguagePage {
	return &AcceptLanguagePage{handler: h}
}

func (i AcceptLanguagePage) Before(response trama.Response, r *http.Request) {
